function akcja()
{
	var obraz = document.querySelector('.zoom');
	
	obraz.style.style.backgroundImage = "url(\"../img/"+mapa+"/Odlegloscipunkty/"+mapa+"_punkt"+punkt+".jpg\")";
}
...
var createZoomedPhoto = function ()
{
	...
	zoom.style.backgroundImage = "url(\"../img/"+mapa+"/Odlegloscipunkty/"+mapa+"_punkt"+punkt+".jpg\")";
	mag.appendChild(zoom);
};
...
var onMouseMove = function (ev)
{
	...
	zoom.style.backgroundPosition = - x*3.5 + "px " + - y*3.5 + "px";
};
